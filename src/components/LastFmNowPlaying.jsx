...
const USER = process.env.NEXT_PUBLIC_LASTFM_USER || process.env.NEXT_PUBLIC_LASTFM_USERNAME || 'HikkiVT';
const KEY  = process.env.NEXT_PUBLIC_LASTFM_KEY  || process.env.NEXT_PUBLIC_LASTFM_API_KEY  || '37bea35ad8f57a95805a5c51747915d3';
