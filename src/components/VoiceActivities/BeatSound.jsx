...
import { Music, X, Radio, Volume2, VolumeX, Trophy, Settings, Play, Pause, Search, Star, Zap, Target, Award, TrendingUp, Crown, Activity } from 'lucide-react';
                        ...
                        try {
                            ...
                            setTimeout(() => {
                                try {
                                    ...
                                    console.error('[BeatSound] Error getting duration:', err);
                                }
                            }, 1500);
                        } catch (err) {
                            console.error('[BeatSound] ❌ Error playing video:', err);
                            toast.error('Error reproduciendo música');
                        }
                    } else {
                        if (!data.trackId) {
                            console.warn('[BeatSound] ⚠️  No track ID provided');
            ...
            try {
                ...
                const player = new YT.Player('youtube-player-beatsound', {
                    ...
                    events: {
                        ...
                        onStateChange: (event) => {
                            console.log('[BeatSound] YouTube state:', event.data);
                        },
                    },
                });
