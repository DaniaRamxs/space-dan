...
export default function AuthWidget() {
  ...
  return (
    <div className="authWidget">
      <div className="authLoginLabel">◈ cuenta</div>
      <button className="authProviderBtn authGoogle" onClick={loginWithGoogle}>
        <svg viewBox="0 0 24 24" className="authProviderIcon" aria-hidden="true">
      ...
      <button className="authProviderBtn authDiscord" onClick={loginWithDiscord}>
        <svg viewBox="0 0 24 24" className="authProviderIcon" aria-hidden="true">
