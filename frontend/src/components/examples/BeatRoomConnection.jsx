...
export default function BeatRoomConnection() {
  ...
  const connectToRoom = async () => {
    try {
      ...
      addLog(`📡 URL del servidor: ${import.meta.env.VITE_COLYSEUS_URL || 'wss://spacely-server-production.up.railway.app'}`, 'info');
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        ...
        {room && (
          <div className="bg-gray-900 rounded p-4 mb-4 space-y-2 text-sm">
            ...
            <div className="text-gray-300">
              <span className="text-gray-500">Servidor:</span> {import.meta.env.VITE_COLYSEUS_URL || 'wss://spacely-server-production.up.railway.app'}
            </div>
          </div>
        )}
